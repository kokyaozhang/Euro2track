                    ...
                    <div class="">
                        ...
                        <div class="flex justify-center">
                            ...
                            <div class="mb-3 w-96">
                                ...
                                <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput6" placeholder="Enter Location:" wire:model="Pr">
