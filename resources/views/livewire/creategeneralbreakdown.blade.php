            ...
            <form>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput4" class="block text-gray-700 text-sm font-bold mb-2">Breakdown problem:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput4" placeholder="Enter Breakdown problem" wire:model="Breakdown_problem">
                            @error('Breakdown_problem') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput26" class="block text-gray-700 text-sm font-bold mb-2">Description:</label>
                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput26" wire:model="Description" placeholder="Enter Description"></textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput26" wire:model="Remarks" placeholder="Enter Remarks"></textarea>
