                ...
                @foreach($data as $fieldequip)
                    <tr>
                        ...
                        <td class="border px-6 py-2 p-4">
                            ...
                            <button wire:click="createmxp('{{ $fieldequip->Identification_No }}')"  class="bg-yellow-400 hover:bg-yellow-700 text-xs text-white font-bold py-2 px-2 rounded">Service</button>
