...
<span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
          ...
          <button wire:click.prevent="dxport()" class="btn btn-info form-control inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-green-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5">
            Export
          </button>
        </span>
