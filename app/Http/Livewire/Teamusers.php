        ...
        foreach($data as $row) {
            ...
            $output1 .= ' <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                    {{--run function once per user id--}}
                                        ...
                                        <td class="p-3 px-5" ><input type="text"  value="'.$row->name.'" class="bg-transparent" readonly></td>
                                        <td class="p-3 px-5" ><input type="text"  value="'.$row->role.'" class="bg-transparent" readonly></td>
