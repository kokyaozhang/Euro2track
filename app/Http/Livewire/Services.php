...
$Nature_of_Problem,
$Validated_by,
$Validated_Date,$calibration_id,$Correction_factor,$calibration,$Year,$Pr,$Next_Due_Date;
...
//paginate this
        ...
        $data = Service::join('fieldequips', 'fieldequips.Identification_No', '=', 'services.Identification_No')
            ->where('fieldequips.type', '=', $id)
            ->paginate(5);

        return view('livewire.calibrations',compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $fieldequip = Fieldequip::where('Identification_No', $this->Identification_No)->first();
