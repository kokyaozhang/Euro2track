 ...
 */
     ...
     * @var array
     */
    public function closerecModal()
    {
        $this->isrecOpen = false;
    }
    /**
     * The attributes that are mass assignable.
     *
     ...
     * @var array
     */
    public function closerepModal()
    {
        $this->isrepOpen = false;
    }
    /**
     * The attributes that are mass assignable.
     *
    ...
    public function alter3()
    {
        ...
        return redirect()->route('sendEmail3');
